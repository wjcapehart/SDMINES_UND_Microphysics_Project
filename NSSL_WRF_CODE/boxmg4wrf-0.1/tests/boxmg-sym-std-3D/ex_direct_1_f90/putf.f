...
!               kss = kGs+k-1
!               !
!               CALL RHS(is,js,kss,hx,hy,hz,fs,s)
!               !
!               qf(i,j,k)    = fs*h2
!               !
!            ENDDO
      ...
      DO k=2, kEND
         DO j=jBEG,jEND
            DO i=2, iEND
               ...
               kss = kGs+k-1
               !
               SO(i,j,k,kps) = da(is,js,kss,hx,hy,hz)*yh
            ENDDO
         ENDDO
      ENDDO
      ...
      DO k=2, kEND
         DO j=2, jEND
            DO i=iBEG, iEND
               ...
               kss = kGs+k-1
               !
               SO(i,j,k,kpw) = dr(is,js,kss,hx,hy,hz)*xh
            ENDDO
         ENDDO
      ENDDO
      ...
      DO k=kBEG, kEND
         DO j=2, jEND
            DO i=2, iEND
               ...
               kss = kGs+k-1
               !
               SO(i,j,k,kb) = dz(is,js,kss,hx,hy,hz)*zh
            ENDDO
         ENDDO
      ENDDO
