...
C -------------------------------------------------------------------------
C     Machine Constants for i686 (Linux NAG f90)
C
      DATA DMACH(1) / 2.225073858507210383D-308  /
      DATA DMACH(2) / 1.797693134862315708D+308  /
      DATA DMACH(3) / 1.110223024625156540D-16   /
      DATA DMACH(4) / 2.220446049250313081D-16   /
