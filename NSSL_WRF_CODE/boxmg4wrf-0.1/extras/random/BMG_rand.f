      REAL*8 FUNCTION BMG_RAND(r)

C ===========================================================================
C
C***BEGIN PROLOGUE  BMG_RAND
C***PURPOSE   Generate a uniformly distributed random number.
C***LIBRARY   SLATEC (FNLIB)
C***CATEGORY  L6A21
C***TYPE      DOUBLE PRECISION (BMG_RAND-D)
...
C variety of computers.  BMG_RAND(R) undoubtedly is not as good as many
...
C          BMG_RAND provided the arithmetic is done exactly.
C
C             Output Value --
C BMG_RAND   a pseudo-random number between 0. and 1.
C
C***REFERENCES  (NONE)
...
c
      ...
      ix1 = mod (iy1, 2048)
c
 10   bmg_rand = ix1*2048 + ix0
      bmg_rand = bmg_rand / rMAGIC
      return
c
