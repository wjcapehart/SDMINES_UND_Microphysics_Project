...
C ------------------------------------------- 
     ...
     &                 BMG_iPARMS(id_BMG2_SER_NCYCLE_TYPE)
         ...
         READ(IO_in,*) BMG_iPARMS(id_BMG3_SER_MAX_ITERS),
...
C ------------------------------------------- 
      ...
      !
      BMG_IOFLAG(iBMG3_SER_OUT_WSPACE_POINT) = .FALSE.
      ...
      BMG_IOFLAG(iBMG3_SER_BUG_PARAMETERS)   = .FALSE.
      !
...
c$$$         IF ( BMG_IOFLAG(iBMG3_SER_BUG_PARAMETERS) ) THEN
c$$$            CALL BMG3_SER_SymStd_DUMP_parms( 
